      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '$_counter',
              style: Theme.of(context).textTheme.headlineSmall,  //headline4,
            ),
            ...
            if (_counter >= 35 && _counter < 60)
              const Text("J'aime me battre. (OSS 117)"),
            if (_counter >= 60 && _counter < 120)
              const Text("J'aime me beurrer la biscotte. (OSS 117)"),
            if (_counter >= 120 && _counter < 200)
              const Text("J'aime le bruit blanc de l'eau. (OSS 117)"),
            if (_counter >= 200 && _counter < 201)
              const Text("J'aime quand on m'enduit d'huile. (OSS 117)"),
            if (_counter >= 201 && _counter < 350)
              const Text(
                  "J'aime quand une jolie femme brune m'apporte mon petit déjeuner au lit. (OSS 117)"),
            if (_counter >= 350)
              const Text("Vous dites ça à toutes les femmes. Larmina")
          ],
        ),
      ),
